...
<style>
    ...
    *{box-sizing:border-box;margin:0;padding:0;}
    ...
    .page-header{background:linear-gradient(135deg,#0d0d0d,#1a1400);border-bottom:1px solid var(--border);padding:32px;}
    ...
    .filter-input{background:#2a2a2a;border:1px solid #444;color:#e0e0e0;border-radius:8px;padding:8px 14px;font-size:13px;margin-left:auto;}
...
<nav class="top-nav">
    ...
    <div class="nav-links">
        ...
        <a href="violations.jsp" class="nav-link-btn active">⚠️ Violations</a>
...
<div class="main-wrapper">
    <div class="page-header">
        <h1>⚠️ All Violations</h1>
        <p>View and manage all recorded traffic violations</p>
    </div>
    <div class="content">
        ...
        <div class="table-card">
            <div style="overflow-x:auto;">
                <table class="custom-table" id="vTable">
                    ...
                    <tr><td colspan="8" style="text-align:center;padding:40px;color:#555;">No violations found.</td></tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="../ViolationController" method="post" onsubmit="return confirm('Delete violation #<%= v.getViolationId() %>?')">
